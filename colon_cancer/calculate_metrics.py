...
for i in params:
    ...
    image_train_list  = list(data_train_path.glob('*/*.jpeg'))
    image_test_list = list(data_test_path.glob('*/*.jpeg'))
    ...
    f1_score_train = (2 * recall_per_class_train * precision_per_class_train)/(recall_per_class_train+precision_per_class_train+1)

    print('F1 score for each class train : ', f1_score_train.tolist())

    #________________________________________________________________

    f1_score_test = (2*recall_per_class_test*precision_per_class_test)/(recall_per_class_test+precision_per_class_test+1)
